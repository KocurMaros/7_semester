...
MAKECMD         = /home/laptop/programs/matlab_exe/bin/glnxa64/gmake
HOST            = UNIX
BUILD           = yes
SYS_TARGET_FILE = any
...
MODEL                   = UM3
MODULES                 = UM3.c UM3_capi.c UM3_data.c UM3_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = UM3
MAKEFILE                = UM3.mk
MATLAB_ROOT             = /home/laptop/programs/matlab_exe
ALT_MATLAB_ROOT         = /home/laptop/programs/matlab_exe
START_DIR               = /home/laptop/school/AI/Cvicenie
S_FUNCTIONS_LIB         = 
NUMST                   = 2
NCSTATES                = 4
COMPUTER                = GLNXA64
BUILDARGS               =  RSIM_SOLVER_SELECTION=1 PCMATLABROOT="/home/laptop/programs/matlab_exe" EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 RSIM_PARAMETER_LOADING=1 OPTS="-DTGTCONN -DIS_SIM_TARGET -DNRT -DRSIM_PARAMETER_LOADING -DRSIM_WITH_SL_SOLVER -DENABLE_SLEXEC_SSBRIDGE=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DON_TARGET_WAIT_FOR_START=0 -DTID01EQ=1"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 1
ALLOCATIONFCN           = 0
...
OPTIMIZATION_FLAGS      = -DNDEBUG -O
ADDITIONAL_LDFLAGS      =  -Wl,--allow-shlib-undefined -Wl,-rpath,/home/laptop/programs/matlab_exe/sys/os/glnxa64
