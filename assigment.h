...
#define LED_ON					*((volatile uint32_t *)((GPIOA_BSRR_REG))) |= (1<<4)/* Add LED_ON implementation here. */
#define LED_OFF					*((volatile uint32_t *)((GPIOA_BRR_REG))) |= (1<<4)/* Add LED_OFF implementation here. */

#define BUTTON_GET_STATE		*((volatile uint32_t *)(GPIOA_IDR_REG)) & (1 << 3)/* Add BUTTON_GET_STATE implementation here. */
