function [result] = decide_if_value_in_interval_is_more_than_input_value(data_array, input_value, low)
...
interval_data = data_array(low:end);
interval_data_in = input_value(low:end);
