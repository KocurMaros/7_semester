...
MODEL               = template_poloha
MODULES_OBJ         = template_poloha_data.obj 
MAKEFILE            = template_poloha.mk
...
TID01EQ             = 1
NCSTATES            = 3
BUILDARGS           =  GENERATE_REPORT=0 TMW_EXTMODE_TESTING=0 MODELLIB=template_polohalib.lib RELATIVE_PATH_TO_ANCHOR=.. MODELREF_TARGET_TYPE=NONE
MULTITASKING        = 0
EXT_MODE            = 1
EXTMODE_TRANSPORT   = 0
EXTMODE_STATIC      = 0
...
# Additional includes
ADD_INCLUDES = &
C:\DOCUME~1\STU_ABB\Plocha\RMS\kocur\TEMPLA~1;&
C:\DOCUME~1\STU_ABB\Plocha\RMS\kocur;&
